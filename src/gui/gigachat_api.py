...
class TokenManager:
    ...
    def refresh_token(self):
        ...
        try:
            ...
            print(f"✓ Токен GigaChat обновлен (действителен до {self.token_expiry.strftime('%H:%M:%S')})")
            return True
...
Верни ТОЛЬКО название одной строкой."""
    ...
    def _clean_response(self, response):
        ...
        # Убираем префиксы
        prefixes = ["Ответ:", "Название:", "Результат:", "Официальное название:", "Нормализованное:"]
        ...
        abbrs = ['ГБОУ', 'МБОУ', 'МАОУ', 'АНОО', 'АНООО', 'АНО', 'ГАПОУ', 'ГБПОУ', 'ФГБОУ', 'СОШ', 'ООО']
        for abbr in abbrs:
